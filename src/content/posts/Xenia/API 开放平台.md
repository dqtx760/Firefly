...
https://aibijia.org - 综合 API 中转服务，价格比较实惠  
https://manage-xai.ainaibahub.com - 专注 Codex 系列模型，支持较强  
https://subrouter.ai - 多模型切换顺畅，适合日常使用  
https://packyapi.com - 提供稳定 API 转发服务  
http://apimart.ai - 支持 AI 生图、生视频等多种创意模型  
http://yunwu.ai - 聚合多家 AI 模型，创意类 API 较全  
https://dapicloud.com - 综合算力和 API 服务平台
...
| 平台                                                                                              | 福利             | 来源                                                     |
| ----------------------------------------------------------------------------------------------- | -------------- | ------------------------------------------------------ |
| https://b.ai/                                                                                   | 获赠500,000 免费积分 | [点此](https://x.com/BAI_AGI/status/2050197122377728073) |
| [https://monkeycode-ai.com](https://monkeycode-ai.com/?ic=019c5715-01a8-7e40-a320-4d16498c5f2d) | **20000 点**    |                                                        |
...
| 工具名称                                                 | 说明                     |     |
| ---------------------------------------------------- | ---------------------- | --- |
| [OpenCode](https://opencode.ai/)                     | 开源 AI 编程编辑器，本地优先       |     |
| [OpenClaw](https://openclaw.ai/)                     | 轻量 AI 编码 CLI，高效开发      |     |
| [Claude Code](https://claude.com/claude-code)        | Anthropic 官方 AI 编程 CLI |     |
| [Codex CLI](https://developers.openai.com/codex/cli) | OpenAI 代码模型命令行工具       |     |
| [Qwen Code](https://qwen.ai/qwencode)                | 通义千问 AI 编程 CLI         |     |
| [Zed](https://zed.dev/)                              | 高性能 AI 原生代码编辑器         |     |
| [Cherry Studio](https://cherry-ai.com/)              | 多 AI 模型聚合客户端           |     |
| [Kilo Code](https://kilo.ai/)                        | VS Code 插件，高效补全        |     |
| [Cline](https://cline.bot/)                          | VS Code 插件，自主编码        |     |
| [Roo Code](https://roocode.com/)                     | VS Code 插件，全流程编码辅助     |     |
