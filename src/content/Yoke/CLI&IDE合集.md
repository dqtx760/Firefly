...
- yt-dlp 油管/视频工具
- discord-cli 社群社交 CLI
- tg-cli/telegram 电报 CLI
- v2ex-cli 论坛社区 CLI
- rdt-cli 海外社区 CLI
- xiaoyuzhou-cli 播客平台 CLI

**文档协作办公载体类**
- lark-cli 飞书 CLI
- notion-cli 知识库文档 CLI
- ticktick-cli 滴答清单任务 CLI
- gmail-cli 谷歌邮箱 CLI
- cc-weixin 微信公众号 CLI
- wechat-ai 微信 AI 工具
...
**MCP 协议对接类**
- lark-mcp 飞书 MCP
- douyin-mcp-server 抖音 MCP 服务端
- linkedin-scraper-mcp 领英抓取 MCP
- chrome-devtools-mcp 浏览器调试 MCP
...
- **企业/团队**：VS Code+Copilot、IntelliJ+JetBrains AI
- **中文/免费**：Trae、Qwen 系
